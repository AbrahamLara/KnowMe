...
// of a file from the given path as a string.
...
// the email.html file in the /template folder as a string and
// replace NAME in the html string with the name of the newly
// registered user
function getEmailTemplate (name) {
  return fileContentToString('/../template/email.html')
